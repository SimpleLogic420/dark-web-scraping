...
function KeyWord({ keywords, setKeywords, pastelist, setPasteList,setAlerts,alerts }: props) {
  ...
  const searchKeywords = async () => {
    const pastelistRes = await axios.get(
      "http://localhost:3010/list/scrape-once"
    );
    const dbpastelist = pastelistRes.data;
  ...
  return (
    <div className="keywordsPage">
      ...
      <p className="keywordDescription">Choose words you want to find in our pastes and when theres a match we will alert you</p>
